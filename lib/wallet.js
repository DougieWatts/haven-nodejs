...
class Wallet {
    constructor(hostname, port, user, pass, timeout) {
        ...
        this._request('get_balance'); // This line is necessary in order to do the initial handshake between this wrapper and haven-wallet-rpc; without it, the first request to the wrapper fails (subsequent request succeed, though.)
    }
}
